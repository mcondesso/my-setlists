...
def authenticate_user(session: Session, email: str, password: str) -> User | None:
    ...
    Plain helper (not a FastAPI dependency) — the login route calls it
    directly with a session. Returns the matching User if the email exists
    and the password is correct, otherwise returns None.
    """
